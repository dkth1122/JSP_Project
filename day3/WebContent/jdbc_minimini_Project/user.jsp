...
<script>
	var form = document.list;
		function userRemove(){
			...
			location.href = "user_remove.jsp?uId=" + form.user.value;
		}//userRemove
		...
		function bchange(kind,uId){
					...
					window.open("user_ban.jsp?uId="+uId+"&kind="+kind,"bpop","width=500, height=300");	
				}//stopop
		...
		function cnt(uId){
			window.open("cnt_reset.jsp?uId="+uId,"cpop","width=500, height=300");	
		}		
		...
		function userUpdate(){
			   ...
			   var form = document.list;
			   window.open("user_update.jsp?uId=" + form.user.value,"upop","width=500, height=300");
			}
